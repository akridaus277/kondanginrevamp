    ...
    <div className="scroll-sidebar" data-sidebarbg="skin6">
      ...
      <nav className="sidebar-nav">
        <ul id="sidebarnav">
          ...
          <li className="sidebar-item"> <a className="sidebar-link sidebar-link" href="app-calendar.html" aria-expanded="false"><i data-feather="calendar" className="feather-icon" /><span className="hide-menu">Export Data Tamu</span></a></li>
          <li className="list-divider" />
          <li className="nav-small-cap"><span className="hide-menu">Add On</span></li>
          <li className="sidebar-item"> <a className="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false"><i data-feather="file-text" className="feather-icon" /><span className="hide-menu">WA Blast </span></a>
          ...
          <li className="sidebar-item"> <a className="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false"><i data-feather="grid" className="feather-icon" /><span className="hide-menu">Company Profil</span></a>
            <ul aria-expanded="false" className="collapse  first-level base-level-line">
